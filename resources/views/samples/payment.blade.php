    ...
    <div class="w-full sm:w-96">
        ...
        <div class="flex flex-col items-center border border-gray-200 shadow-lg rounded-xl px-4 py-6">
            ...
            <div class="flex items-center justify-between mt-6 w-full cursor-default text-xs xs:text-sm text-gray-500">
                ...
                <span class="variable-font-medium">340٬000 تومانءءء</span>
            </div>
            <div class="flex items-center justify-between mt-2 w-full text-xs xs:text-sm">
                ...
                <div class="flex items-center justify-end mt-0.5">
                    <div class="text-green-600 variable-font-medium">
                        <span x-text="gift.type == 'percent' ? '٪' : ''">15%</span>
            ...
            <div class="flex items-center justify-between mt-2 w-full text-xs xs:text-sm text-gray-500">
                ...
                <div class="flex items-center justify-end mt-0.5">
                    <span class="variable-font-medium">247٬500 تومانءءء</span>
                </div>
            </div>
            <div class="mt-4 pt-2 border-t border-gray-300 w-full flex flex-col">
                <div class="flex items-center justify-between mt-2 text-xs xs:text-sm text-gray-500">
                    ...
                    <div class="flex items-center justify-end mt-0.5">
                        <span class="variable-font-medium">15٬000 تومانءءء</span>
                    </div>
                </div>
                <div class="flex items-center justify-between mt-2">
                    <span class="text-xs xs:text-sm text-gray-500">مبلغ قابل پرداخت</span>
                    <span class="text-sm xs:text-base text-gray-600 variable-font-semibold mt-0.5 text-left">250٬500 تومانءءء</span>
                </div>
            </div>
        </div>
        <div class="mt-4">
        ...
        <a href="#" class="direct flex items-center justify-center text-white text-sm bg-green-500 hover:bg-green-600 transition rounded-full h-10 mt-6 focus-current ring-green-500 spinner">@lang('پرداخت')</a>
        <a href="#" class="direct flex items-center justify-center text-brand text-sm hover:bg-blue-50 border border-brand transition rounded-full h-10 mt-2 focus spinner">@lang('اجرای آزمون بدون پرداخت')</a>
    </div>
</div>