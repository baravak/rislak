@section('auth-form')
    ...
    <div class="mb-2">
        <input type="authorized_key" disabled value="0{{ substr($theory->response('authorized_key'), 2)  }}" class="w-full text-sm text-left dir-ltr text-gray-400 border border-gray-200 rounded h-10 px-3" id="authorized_key" name="authorized_key">
    </div>
    <div class="mb-4">
