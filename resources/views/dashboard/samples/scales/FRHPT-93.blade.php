@php
    $_aProfiles = [
        ['صفحه دو', 'profile_items_sort_key_png', 'profile_page2_png'],
        ['صفحه سه', 'profile_items_sort_value_png', 'profile_page3_png'],
        ['صفحه چهار', 'profile_items_sort_value_png', 'profile_page4_png'],
];
@endphp
