    ...
    <div x-show="room">
        ...
        <div class="mt-4">
            <label for="purchase" class="flex items-center cursor-pointer group">
                <input checked id="purchase" name="purchase" type="checkbox" x-model="purchase" class="w-5 h-5 rounded border border-gray-400 focus" x-on:change="$el.checked && document.querySelector('#amountSum').dispatchEvent(new Event('sum')) " value="1">
        ...
        <div x-show="scales_count">
            ...
            <div class="mt-4">
                <label for="prepayment" class="flex items-center cursor-pointer group">
                    <input checked id="prepayment" name="prepayment" type="checkbox" class="w-5 h-5 rounded border border-gray-400 focus" value="1">
