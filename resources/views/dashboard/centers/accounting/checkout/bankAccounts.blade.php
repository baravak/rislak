<div class="grid grid-cols-1 gap-2 mt-2">
    <div class="relative flex items-center justify-center xs:justify-between border border-gray-300 rounded p-4">
        ...
        <div>
            <button class="absolute left-2 top-2 xs:relative xs:top-0.5 xs:left-auto flex items-center justify-center text-gray-400 hover:text-red-600 transition text-sm h-6 w-6 rounded-full focus:text-red-600 focus-current ring-red-600">
    ...
    <div class="relative flex items-center justify-center xs:justify-between border border-gray-300 rounded p-4">
        <div class="flex items-center cursor-default flex-col xs:flex-row">
            <div class="flex items-center justify-center border border-gray-200 rounded-full w-10 h-10 p-2 ml-2">
                <img src="https://next.zarinpal.com/images/Mellat.png" alt="">
            </div>
            <div class="flex flex-col mt-2 xs:mt-0 text-center xs:text-right">
