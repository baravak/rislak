                ...
                <div class="relative dropdown">
                    ...
                    <div class="dropdown-menu absolute w-56 left-0 top-9 bg-white rounded-md shadow-md flex flex-col z-50 divide-y divide-gray-200">
                        ...
                        <div class="flex items-center justify-between text-gray-500 hover:bg-gray-50 hover:bg-opacity-50 hover:text-brand transition px-3 py-2">
                            ...
                            <button class="h-6 px-2 text-xs text-gray-500 border border-gray-200 hover:border-brand hover:text-brand transition rounded-full focus" data-clipboard-text="{{ $gift->postcard->url }}">@lang('کپی لینک')</button>
                        </div>
                        <div class="flex items-center justify-between text-gray-500 hover:bg-gray-50 hover:bg-opacity-50 hover:text-gray-900 transition px-3 py-2">
                            ...
                            <button class="h-6 px-2 text-xs text-gray-500 border border-gray-200 hover:border-brand hover:text-brand transition rounded-full focus" data-clipboard-text="{{ $gift->postcard->image  }}">@lang('کپی لینک')</button>
                        </div>
                    </div>
                </div>
            </div>
