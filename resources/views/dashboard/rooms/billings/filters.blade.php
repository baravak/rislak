<div class="flex items-center justify-end mb-4 flex-wrap">
    ...
    <a data-lijax data-method="post" href="{{ route('dashboard.room.billings.export', array_merge(request()->except(['page']), ['room' => $room->id]))  }}" class="mt-2 sm:mt-0 flex items-center bg-brand rounded-full h-8 px-8 text-white text-xs hover:bg-blue-700 transition focus">
