                    ...
                    @can('viewAny', [App\RoomUser::class, $room])
                        <div class="relative dropdown">
                            ...
                            <div class="rounded bg-white border border-gray-200 mt-2 shadow-md dropdown-menu w-52 absolute left-0">
                                ...
                                <a href="{{ route('dashboard.room.accounting.index', $room->id) }}" class="flex items-center text-sm text-gray-700 py-3 pl-4 pr-10 hover:bg-gray-100 border-b border-gray-100 transition dir-rtl">
