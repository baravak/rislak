        ...
        <div class="grid grid-cols-1 xs:grid-cols-2 gap-4 mt-4">
            ...
            <div x-data='{"disable" : true}'>
                <div class="block mb-1">
                    <input type="checkbox" name="use-more-one" id="use-more-one" class="w-4 h-4 border border-gray-600 rounded-sm focus:ring-1 focus:ring-offset-1" x-model="disable">
